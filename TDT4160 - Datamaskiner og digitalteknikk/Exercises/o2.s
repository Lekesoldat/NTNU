...
SetupGPIOConfig:
	...
	orr r1, 0b0001 << 4 // Bit patter for EXTIPSELH for pin 9 to 0001
	...
	str r1, [r0] // Store data at address
	...
	str r1, [r0] // Store bit pattern for enabling of pin 9
...
SetupSysTickConfig:
	...
	mov r1, #0b110 // Enable gecko clock, generate interrupt, start/stop
	str r1, [r0]
	...
	str r0, [r1] // Store frequency / 10 in LOAD
...
reset_tenth:
	// Toggle LED
	ldr r10, =GPIO_BASE + LED_PORT * PORT_SIZE + GPIO_PORT_DOUTTGL // Load address for toggling
