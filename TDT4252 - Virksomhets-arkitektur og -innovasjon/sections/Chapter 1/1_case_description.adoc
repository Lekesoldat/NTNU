...
My biggest motivation for the presented case is to figure out how to streamline the restocking process and thus provide better and more predictable availability of the items in Kiosken. 
...
It is a common practice to wait for Kiosken to be almost out of all items before a restock is even planned. 
...
The shopping is done at certain grocery stores with an agreement benefiting both parts.
