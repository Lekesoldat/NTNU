...
As a student, one would like to have all items available at all times. 
However, through some research, it is clear that the availability of items is unpredictable. 
